...
def top_level_task():
  ...
  output_tensors = PyTorchModel.file_to_ff("/mnt/model.ff", ffmodel, [input_tensor])

  ffoptimizer = AdamOptimizer(ffmodel)
...
if __name__ == "__main__":
  print("this script has some problem. Use c++ instead.")
  top_level_task()
